...
public class ItemSpriteSheet {
	...
	public static final int MAGIC_STONE		= SINGLE_USE+2;
	...
	static{
		...
		assignItemRect(MAGIC_STONE,		11, 10);
	...
	public static final int RUNIC_SHORTWORD     = WEP_TIER1+6;
	static{
		assignItemRect(WORN_SHORTSWORD, 13, 13);
		assignItemRect(GLOVES,          12, 16);
		assignItemRect(DAGGER,          12, 13);
		assignItemRect(MAGES_STAFF,     15, 16);
		assignItemRect(RUNIC_SHORTWORD,	13, 13);
	}
	...
	public static final int ROUND_WAIST_HAMMER	= WEP_TIER2+5;
	static{
		...
		assignItemRect(ROUND_WAIST_HAMMER,  14, 16);
	}
	...
	public static final int ARMOR_RUNEMAGE  = ARMOR+9;
	static{
		...
		assignItemRect(ARMOR_RUNEMAGE,  16, 15);
	}
	...
	public static final int ARTIFACT_PINKCANDLE1= ARTIFACTS+23;
	public static final int ARTIFACT_PINKCANDLE2= ARTIFACTS+24;
	public static final int ARTIFACT_PINKCANDLE3= ARTIFACTS+25;
	public static final int ARTIFACT_PINKCANDLE4= ARTIFACTS+26;
	static{
		...
		assignItemRect(ARTIFACT_PINKCANDLE1,7,  11);
		assignItemRect(ARTIFACT_PINKCANDLE2,7,  12);
		assignItemRect(ARTIFACT_PINKCANDLE3,7,  14);
		assignItemRect(ARTIFACT_PINKCANDLE4,8,  15);
	}
	...
	public static final int PINK_BLOB	= QUEST+8;
	public static final int SHARD   	= QUEST+9;
	static{
