...
//				btnQuick[4].setPos(btnInventory.left() + 2, (y * 3 / 10) + visible[4]);
//				btnQuick[5].setPos(btnInventory.left() + 2,  btnQuick[4].bottom() + visible[5]);
//				btnQuick[6].setPos(btnInventory.left() + 2, btnQuick[5].bottom() + visible[6]);
//				btnQuick[7].setPos(btnInventory.left() + 2, btnQuick[6].bottom() + visible[7]);
				break;
		...
		btnQuick[4].setPos(width - btnInventory.width() + 2, (y * 3 / 10) + visible[4]);
		btnQuick[5].setPos(width - btnQuick[7].width(),  btnQuick[4].bottom() + visible[5]);
		btnQuick[6].setPos(width - btnQuick[7].width(), btnQuick[5].bottom() + visible[6]);
		btnQuick[7].setPos(width - btnQuick[7].width(), btnQuick[6].bottom() + visible[7]);
