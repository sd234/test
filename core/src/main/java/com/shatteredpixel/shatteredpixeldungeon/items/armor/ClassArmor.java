...
abstract public class ClassArmor extends Armor {
	...
	public static ClassArmor upgrade ( Hero owner, Armor armor ) {
		...
		case HUNTRESS:
			...
			break;
		case RUNEMAGE:
			classArmor = new RunemageArmor();
			break;
		}
		
		classArmor.level(armor.level() - (armor.curseInfusionBonus ? 1 : 0) - (armor.augmentBonus ? 1 : 0));
		...
		classArmor.augmentBonus = armor.augmentBonus;
		classArmor.identify();
